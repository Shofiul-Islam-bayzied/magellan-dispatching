...
export default function Testimonials() {
  ...
  return (
    <section className="py-20 lg:py-28 bg-[#F8F9FA] text-foreground">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-16 sm:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-4 sm:mb-6 uppercase tracking-tighter leading-tight">
