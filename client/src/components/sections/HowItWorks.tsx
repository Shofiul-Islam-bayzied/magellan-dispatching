    ...
    <section className="py-24 bg-white" id="how-it-works">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-16 sm:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-foreground mb-4 sm:mb-6 uppercase tracking-tighter leading-tight">
        ...
        <div className="mt-12 sm:mt-20 text-center">
          <button 
            ...
            className="bg-[#0B3C5D] text-white px-8 py-4 sm:px-10 sm:py-5 font-display font-bold text-lg sm:text-xl uppercase tracking-widest hover:bg-primary transition-colors duration-300 shadow-[4px_4px_0px_0px_rgba(249,115,22,1)] sm:shadow-[8px_8px_0px_0px_rgba(249,115,22,1)] hover:shadow-none hover:translate-y-1 hover:translate-x-1 sm:hover:translate-y-2 sm:hover:translate-x-2"
          >
            Start Step 1 Now
          </button>
        </div>
